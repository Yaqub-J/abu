...
export default function SignIn() {
  ...
  const handleSocialSignIn = async (provider: 'Google' | 'Facebook') => {
    try {
      setLoading(true);
      // Note: signInWithRedirect will redirect to the provider's login page
      // The user will be automatically redirected back to your app after successful authentication
      await signInWithRedirect({ provider: provider === 'Google' ? 'Google' : 'Facebook' });
    } catch (err: any) {
