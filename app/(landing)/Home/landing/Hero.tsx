        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-6 md:px-12 lg:px-20">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-16">
              <Link href="/signin" className="inline-block text-center py-3 px-8 rounded-full border-2 border-white text-white hover:bg-white hover:text-black transition-colors duration-300 text-lg font-medium">
                  Login
              </Link>
